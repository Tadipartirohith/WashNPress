...
CREATE TABLE IF NOT EXISTS attachments (id TEXT PRIMARY KEY, doc JSONB NOT NULL);
CREATE TABLE IF NOT EXISTS refund_requests (id TEXT PRIMARY KEY, doc JSONB NOT NULL);
CREATE TABLE IF NOT EXISTS additional_service_slots (id TEXT PRIMARY KEY, doc JSONB NOT NULL);
...
CREATE TABLE IF NOT EXISTS outbox_events (id TEXT PRIMARY KEY, doc JSONB NOT NULL, status TEXT NOT NULL, claimed_at TEXT);
ALTER TABLE outbox_events ADD COLUMN IF NOT EXISTS claimed_at TEXT;
