...
import { HttpMessageProvider, FcmPushProvider, LoggingNotificationProvider, type NotificationMessage, type NotificationProvider } from "./providers";
...
export class CompositeNotificationProvider implements NotificationProvider {
  ...
  constructor(config: AppConfig) {
    ...
    this.push = n.push.enabled && n.push.baseUrl && n.push.serverKey ? new FcmPushProvider(n.push.baseUrl, n.push.serverKey) : this.mock;
  }
